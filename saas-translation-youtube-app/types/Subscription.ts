...
export interface Subscription {
    id?: string;
/** 
*   Set of key-value pair? hat you can attach to an object.
...
/** If the subscription has been canceled, the date of that cancellation. If the subscription was canceled with cancel_at_period_end', canceled_at' will still reflect the date of the initial cancellation request, not the end of the subscription period when the subscription Is automatically noved to a canceled state.
 */
