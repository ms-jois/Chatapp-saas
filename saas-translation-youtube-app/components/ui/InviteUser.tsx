...
function InviteUser({chatId} :{chatId: string}) {
    ...
    async function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        toast({
            ...
            description: "You've exceeded the limit of users in a single chat for the FREE plan. Please upgrade to PRO to continue adding users to chats!",
            variant: "destructive",
            action:(
                <ToastAction 
                altText= "Upgrade"
    ...
    if (querySnapshot.empty) {
        toast ({
            ...
            description: "Please enter an email address of a registered user OR resend the invitiation once they have signed up!",
            variant: "destructive",
        });
        return;
    } else {
